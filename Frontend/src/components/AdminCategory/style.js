...
export const FilterChip = styled.button`
  ...
  background: ${(props) => (props.$active ? "rgba(37, 99, 235, 0.12)" : "#f9fafb")};
  color: ${(props) => (props.$active ? "#1d4ed8" : "#374151")};
  
  padding: 10px 20px;        /* tăng kích thước */
  font-size: 15px;           /* chữ lớn hơn */
  border-radius: 999px;
  ...
  align-items: center;
  gap: 8px;
  height: 30px;              /* giúp button cân đối */
  min-width: 80px;          /* đảm bảo 3 nút đều nhau */
...
export const CategoryUpload = styled(BaseUpload)`
